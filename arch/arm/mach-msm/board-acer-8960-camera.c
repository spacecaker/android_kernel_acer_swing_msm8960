...
static struct i2c_board_info msm_act_main_cam_i2c_info = {
	I2C_BOARD_INFO("msm_actuator", 0xc),
};
...
static struct camera_vreg_t ov9740_cam_vreg[] = {
	{"cam_vdig", REG_LDO, 1200000, 1200000, 105000},
	{"cam_vio", REG_VS, 0, 0, 0},
	{"cam_vana", REG_LDO, 2800000, 2850000, 85600},
};
...
static struct msm_camera_sensor_platform_info sensor_board_info_ov9740 = {
	.mount_angle = 270,
	.cam_vreg = ov9740_cam_vreg,
	.num_vreg = ARRAY_SIZE(ov9740_cam_vreg),
