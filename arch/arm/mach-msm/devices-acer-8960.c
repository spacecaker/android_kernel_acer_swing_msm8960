...
#define GSBI3_I2C_SDA		16
#define GSBI3_I2C_CLK		17
#define GSBI4_I2C_SDA		20
#define GSBI4_I2C_CLK		21
#define GSBI10_I2C_SDA		73
#define GSBI10_I2C_CLK		74
#endif
...
static struct resource resources_qup_i2c_gsbi10[] = {
	...
	{
		.name	= "i2c_clk",
		.start	= GSBI10_I2C_CLK,
		.end	= GSBI10_I2C_CLK,
		.flags	= IORESOURCE_IO,
	},
	{
		.name	= "i2c_sda",
		.start	= GSBI10_I2C_SDA,
		.end	= GSBI10_I2C_SDA,
		.flags	= IORESOURCE_IO,
	},
#endif
